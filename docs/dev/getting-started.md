...
If you only read one page first, read this one — then follow the links.
...
97 C# scripts under `Assets/_Game/` implement the player core, momentum system, all 4 classes + 16
abilities, objectives + match flow, the full HUD, menus, bots, audio, and progression — built
...
1. [Environment Setup](/dev/environment) — set up a blank machine: Unity, Git LFS, IDE, .NET, Node.
